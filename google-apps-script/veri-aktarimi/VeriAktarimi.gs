/**
 * GOOGLE SHEETS VERİ AKTARIM SİSTEMİ
 * Kaynak spreadsheet'ten hedef spreadsheet'e veri aktarımı
 */

// Konfigürasyon
const KAYNAK_SPREADSHEET_ID = '1ncEnE6vG76HIXFzJRRWz2yehiN2oolg4t2pzfbKt2vI';
const HEDEF_SPREADSHEET_ID = '1CCWtHyWUBPw8LnIlHQ1DdeXwJHPyiCgYPTxeJo3nn_M';

// Aktarılacak sayfalar
const AKTARILACAK_SAYFALAR = [
  'GunlukVeriler',
  'GunlukVeriler_Gecmis', 
  'BuharVerileri',
  'SaatlikVeriler'
];

/**
 * Ana aktarım fonksiyonu - tüm sayfaları aktarır
 */
function tumSayfalariAktar() {
  const sonuc = {
...
function sayfaAktar(kaynakSpreadsheet, hedefSpreadsheet, sayfaAdi) {
  ...
  try {
    ...
    // Hedef sayfayı temizle (başlık hariç)
