...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Bugünün tarihini al ve input'a ata (DD.MM.YYYY formatında) - readonly kilitle
    ...
    function setVardiyaByHour() {
        ...
        // Otomatik seçimi kilitle - kullanıcı değiştiremez
    ...
    temizleBtn.addEventListener('click', function() {
        ...
        // Tarih: bugünü yeniden ata ve kilitle
