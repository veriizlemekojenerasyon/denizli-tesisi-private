...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // tarihSecimi readonly — input/change event listener'ları kaldırıldı

    // vardiyaSecimi kilitli — change event listener kaldırıldı
    ...
    // Vardiya ve tarih change listener'ları kaldırıldı (kilitli)

    // tarihSecimi readonly — change event listener kaldırıldı
    ...
    setInterval(() => {
        ...
        // vardiyaSecimi kilitli — otomatik güncelleme devre dışı
    }, 30000);
});
